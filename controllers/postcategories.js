...
const getCategory = async( req, res = response ) => {
    ...
    // console.log(id)
    const category = await PostCategory.findById( id ).populate('user', 'category');	
...
const postCategory = async( req, res= response)  => {
    ...
    // crear categoria
    const categorySave = new PostCategory( data );
...
const updateCategory = async( req, res ) => {
    ...
    const category = await PostCategory.findByIdAndUpdate( id, rest, { new: true });
